...
const CONFIG = Object.freeze({
    ...
    renewPostSettleMs: numberEnv('KATABUMP_RENEW_POST_SETTLE_MS', 3_000, { min: 250, max: 15_000, integer: true }),
    renewCfWaitMs: numberEnv('KATABUMP_RENEW_CF_WAIT_MS', 10_000, { min: 1_000, max: 30_000, integer: true }),
